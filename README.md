# SprintIQ
A project I'm building to solve a problem I've seen firsthand — engineering teams using GitHub, Jira, and Slack separately but never having a single place that connects everything together.
